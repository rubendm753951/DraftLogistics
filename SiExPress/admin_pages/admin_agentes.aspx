    ...
    <div style="position: absolute; top: 160px; left: 220px; width: 626px;">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                                ...
                                <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Width="800px">
                                    <asp:GridView class="table table-striped table-bordered table-hover" ID="GridView1" runat="server" Font-Size="10pt" DataSourceID="Agencias" AllowPaging="True" DataKeyNames="id_agencia" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="recibo" HeaderText="recibo" SortExpression="recibo" Visible="False"></asp:BoundField>
                ...
                <asp:SqlDataSource ID="Paises" runat="server" SelectCommandType="StoredProcedure" SelectCommand="sp_SelectPaises" ConnectionString="<%$ ConnectionStrings:paqueteriaDB_ConnectionString %>"></asp:SqlDataSource>
                <asp:SqlDataSource ID="Monedas" runat="server" SelectCommandType="StoredProcedure" SelectCommand="sp_SelectMonedas" ConnectionString="<%$ ConnectionStrings:paqueteriaDB_ConnectionString %>"></asp:SqlDataSource>
                ...
                <asp:SqlDataSource ID="Recibos" runat="server"
                    ...
                    SelectCommand="sp_SelectRecibos" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
</asp:Content>
