<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="importar_reconciliacion_proveedores.aspx.vb" EnableViewState="true" Inherits="admin_pages_importar_reconciliacion_proveedores" Title="Importar Reconciliacion Proveedores" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <fieldset>
                        <!-- Form Name -->
                        <legend>Importar Reconciliacion Proveedores</legend>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12 col-sm-12 text-center gridWidth" id="estafetaRequest">
                                <table id="gridProveedores" class=" table table-striped table-bordered table-condensed"></table>
                                <div id="pagerProveedores"></div>
                            </div>                            
                        </div>
                    </fieldset>
                </div>
...
<asp:Content ContentPlaceHolderID="ScriptSection" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/importarReconciliacionProveedores.js"></script>
    <script type="text/javascript" src="../Scripts/jquery.ui.widget.js"></script>
    <script type="text/javascript" src="../Scripts/jquery.iframe-transport.js"></script>
    <script type="text/javascript" src="../Scripts/jquery.fileupload.js"></script>    
    <script type="text/javascript" src="../Scripts/FileUploadImportarReconciliacionProveedores.js"></script>    
</asp:Content>