                                    ...
                                    <tr>
                                        <td colspan="3" style="height: 20px" valign="top">                                            
                                            ...
                                            <asp:Panel ID="checkoutPanel" runat="server" Height="195px" Width="400px"
                                                ...
                                                <br />
                                                <asp:Button CssClass="btn btn-outline btn-success btn-sm" ID="btnAceptar" Style="margin-left: 15px" onClientClick="this.disabled=true;" UseSubmitBehavior="false" OnClick="Inserta_Click" runat="server" Text="Guardar Envío" Width="118px"></asp:Button>
