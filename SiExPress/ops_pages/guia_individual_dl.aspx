<%@ Page Language="VB" AutoEventWireup="false" CodeFile="guia_individual_dl.aspx.vb" Inherits="ops_pages_guia_individual_dl" %>
...
<body>
    ...
    <div style="text-align: center">
            ...
            SelectCommand="sp_Select_Datos_Envio_Mult_DL" SelectCommandType="StoredProcedure">
            <SelectParameters>
